    ...
    <div class="card card-statistics">
      <div class="card-body">
        ...
        <p class="text-muted mt-3 mb-0 text-left text-md-center">
          <i class="mdi mdi-alert-octagon mr-1" aria-hidden="true"></i> Services</p>
      </div>
    </div>
  </div>
  <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 grid-margin stretch-card">
    <div class="card card-statistics">
      <div class="card-body">
        ...
        <p class="text-muted mt-3 mb-0 text-left text-md-center">
          <i class="mdi mdi-message mr-1" aria-hidden="true"></i> Services Quote</p>
      </div>
    </div>
  </div>
  <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 grid-margin stretch-card">
    <div class="card card-statistics">
      <div class="card-body">
        ...
        <p class="text-muted mt-3 mb-0 text-left text-md-center">
          <i class="mdi mdi-calendar mr-1" aria-hidden="true"></i> Notification </p>
      </div>
    </div>
  </div>
  <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 grid-margin stretch-card">
  ...
  <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 grid-margin stretch-card">
    <div class="card card-statistics">
      <div class="card-body">
        ...
        <p class="text-muted mt-3 mb-0 text-left text-md-center">
          <i class="mdi mdi-reload mr-1" aria-hidden="true"></i> Check-in </p>
      </div>
    </div>
  </div>
  <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 grid-margin stretch-card">
